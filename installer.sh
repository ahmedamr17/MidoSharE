...
echo "├────────────────────────────────────────────────────┤"
echo "│ This script will install the MidoSharE plugin      │"
...
# === Configuration ===
ZIP_PATH="/tmp/MidoSharE.zip"
EXTRACT_DIR="/tmp/MidoSharE"
INSTALL_DIR="/usr/lib/enigma2/python/Plugins/Extensions"

PLUGIN_URL="https://github.com/ahmedamr17/MidoSharE/raw/refs/heads/main/MidoSharE.zip"

# === Step 1: Download ===
echo "[1/4] 🔽 Downloading plugin package from:"
echo "    https://github.com/ahmedamr17/MidoSharE/raw/refs/heads/main/MidoSharE.zip"
...
rm -rf "$INSTALL_DIR/MidoSharE"
cp -r "$EXTRACT_DIR/MidoSharE" "$INSTALL_DIR"
if [ [ $? -ne 0 ]; then
...
echo ""
echo "🎉 The plugin \"MidoSharE\" (v1.89) has been installed successfully."
